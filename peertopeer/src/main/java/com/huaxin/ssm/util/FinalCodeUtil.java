...
public class FinalCodeUtil {
	...
	public static final String DEDUCT_PTAH="http://localhost:8080/peertopeer";//请求路径
	//public static final String DEDUCT_PTAH="http://172.16.152.218:8888/deductSer";//请求路径
